...
function getBorderWidth(ele){
		var borderL = parseFloat($(ele).css('border-left-width'));
		var borderR = parseFloat($(ele).css('border-right-width'));
		return borderL + borderR;
	}

function getBorderHeight(ele){
		var borderT = parseFloat($(ele).css('border-top-width'));
		var borderB = parseFloat($(ele).css('border-bottom-width'));
